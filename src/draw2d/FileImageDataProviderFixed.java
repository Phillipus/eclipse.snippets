 ...
 * changes.
 */
public class FileImageDataProviderFixed implements ImageDataProvider {
	private final Class<?> clazz;
	private final String basePath;
	private final String fileExtension;

	public FileImageDataProviderFixed(Class<?> clazz, String path) {
	...
	public static Image createImage(Class<?> clazz, String name) {
		return new Image(null, new FileImageDataProviderFixed(clazz, name));
	}
}
